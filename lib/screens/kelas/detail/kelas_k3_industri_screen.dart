...
import '../materi k3 industri/kuis_screen.dart';
import '../materi k3 industri/materi_apa_itu_k3.dart';
import '../materi k3 industri/materi_manajemen_k3.dart';
import '../materi k3 industri/materi_perkenalan.dart';

class ClassK3IndustriDetailScreen extends StatelessWidget {
  final String title;
  final String image;

  const ClassK3IndustriDetailScreen({
    super.key,
    required this.title,
    required this.image,
  });
