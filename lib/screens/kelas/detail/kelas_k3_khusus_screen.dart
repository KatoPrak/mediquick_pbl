...
import '../materi k3 khusus/materi_perkenalan.dart';
import '../materi k3 khusus/materi_apa_itu_k3.dart';
import '../materi k3 khusus/materi_manajemen_k3.dart';
import '../materi k3 khusus/kuis_screen.dart';

class ClassK3KhususDetailScreen extends StatelessWidget {
  final String title;
  final String image;

  const ClassK3KhususDetailScreen({
    super.key,
    required this.title,
    required this.image,
  });
