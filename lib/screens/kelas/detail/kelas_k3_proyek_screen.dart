...
import '../materi k3 proyek/kuis_screen.dart';
import '../materi k3 proyek/materi_apa_itu_k3.dart';
import '../materi k3 proyek/materi_manajemen_k3.dart';
import '../materi k3 proyek/materi_perkenalan.dart';

class ClassK3ProyekDetailScreen extends StatelessWidget {
  final String title;
  final String image;

  const ClassK3ProyekDetailScreen({
    super.key,
    required this.title,
    required this.image,
  });
